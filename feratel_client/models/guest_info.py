...
class GuestInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["salutationId", "title", "salutation", "company", "firstName", "lastName", "address", "zipCode", "town", "countryCode", "phone", "mobile", "fax", "eMail", "language", "consents"]

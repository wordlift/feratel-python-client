...
class AxessTicketInputData(BaseModel):
    """
    AxessTicketInputData
    """ # noqa: E501
    card_number: Optional[StrictStr] = Field(default=None, alias="cardNumber")
    selected_delivery_mode: Optional[AxessDeliveryModeType] = Field(default=None, alias="selectedDeliveryMode")
    __properties: ClassVar[List[str]] = ["cardNumber", "selectedDeliveryMode"]

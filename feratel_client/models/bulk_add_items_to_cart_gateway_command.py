...
class BulkAddItemsToCartGatewayCommand(BaseModel):
    """
    BulkAddItemsToCartGatewayCommand
    """ # noqa: E501
    groups: Optional[List[BulkAddItemsToCartGatewayGroup]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [BulkAddItemsToCartGatewayGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj

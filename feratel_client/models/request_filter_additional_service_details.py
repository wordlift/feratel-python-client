...
class RequestFilterAdditionalServiceDetails(BaseModel):
    """
    ...
    duration_type: Optional[DurationType] = Field(default=None, alias="durationType")
    units: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["startDate", "startTime", "duration", "durationType", "units"]

...
class SaveEndUserCommandUpdateShoppingCartGuestDataCommand(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["databaseCode", "salutationId", "firstName", "lastName", "company", "city", "zipCode", "email", "address1", "address2", "country", "mobile", "phone", "fax", "currencyCode", "language", "uidNumber", "owner", "marketingCodes"]

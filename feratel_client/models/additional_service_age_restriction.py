...
class AdditionalServiceAgeRestriction(BaseModel):
    """
    AdditionalServiceAgeRestriction
    """ # noqa: E501
    has_age_restriction: Optional[StrictBool] = Field(default=None, alias="hasAgeRestriction")
    use_age: Optional[StrictBool] = Field(default=None, alias="useAge")
    var_from: Optional[StrictInt] = Field(default=None, alias="from")
    to: Optional[StrictInt] = None
    values: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["hasAgeRestriction", "useAge", "from", "to", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hasAgeRestriction": obj.get("hasAgeRestriction"),
            "useAge": obj.get("useAge"),
            "from": obj.get("from"),
            "to": obj.get("to"),
